...
void main() {
  ...
  test('Test key to adress', () {
    ...
    Uint8List address = Adress.publicKeyToAddressBytes(pub);
    expect(address, hexToBytes("d989829d88b0ed1b06edf5c50174ecfa64f14a64"));

    String address2 = Adress.publicKeyToAddressString(pub);
  ...
  test('Test checksum adress', () {
    ...
    for (String item in addresses) {
      expect(item, Adress.toChecksumAddress(item));
    }
