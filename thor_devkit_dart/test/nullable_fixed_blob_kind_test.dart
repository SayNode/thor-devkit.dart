...
void main() {
  test('encode', () {
    NullableFixedBlobKind fbk = new NullableFixedBlobKind(4); // 4 bytes fixed.
    fbk.setValue("0x12345678");
    expect(bytesToHex(fbk.toBytes()), "12345678");
  });

  test('wrong length', () {
    NullableFixedBlobKind fbk = new NullableFixedBlobKind(4);
  ...
  test('encode null', () {
    NullableFixedBlobKind nfbk = new NullableFixedBlobKind(4); // 4 bytes fixed.
    nfbk.setValue(null);
